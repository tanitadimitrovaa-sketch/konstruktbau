...
export default function Home() {
  ...
  >
    Kontakt
      ...
      <section className="relative h-screen min-h-[720px] pt-28 md:pt-32 overflow-hidden bg-slate-950">
        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full px-6 flex items-center">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="h-[2px] w-14" style={{ backgroundColor: logoBlue }} />
              <span className="text-xs font-black uppercase tracking-[0.35em] text-blue-300">
                KonstruktBau GmbH
              </span>
            </div>

            <h1 className="text-5xl md:text-7xl lg:text-6xl font-black uppercase tracking-tighter leading-[0.9] mb-10">
              Willkommen bei der <br />
              <span style={{ color: logoBlue }}>KonstruktBau GmbH</span>
            </h1>

            <p className="text-lg md:text-2xl text-slate-200 max-w-2xl leading-relaxed font-light mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href={phoneHref}
                className="bg-white text-slate-950 px-10 py-5 text-sm uppercase tracking-[0.25em] font-black hover:bg-slate-100 transition-all"
              >
                Jetzt anrufen
              </a>
              ...
              <a
                href={`mailto:${email}`}
                className="border border-white/30 text-white px-10 py-5 text-sm uppercase tracking-[0.25em] font-black hover:bg-white/10 transition-all"
              >
                E-Mail senden
              </a>
            </div>
      ...
      <section className="py-28 md:py-36 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5">
            <p className="text-xs font-black uppercase tracking-[0.4em] text-blue-500 mb-6">
              Über KonstruktBau
            </p>
          ...
          <div className="lg:col-span-7">
            <p className="text-xl md:text-2xl leading-relaxed text-slate-500 font-light mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {["Präzise", "Zuverlässig", "Sauber"].map((item) => (
                <div key={item} className="border-l-4 pl-5" style={{ borderColor: logoBlue }}>
      ...
      <section className="py-28 md:py-36 px-6 bg-slate-950 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between gap-10 mb-20">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.4em] text-blue-400 mb-6">
                Dienstleistungen
              </p>
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight leading-none">
                Leistungen
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 border border-white/10">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="p-8 md:p-12 border-b md:border-r border-white/10 group hover:bg-white/[0.03] transition-all"
              >
      ...
      <section className="relative h-[520px] md:h-[680px] overflow-hidden bg-slate-950">
        <SafeImage
        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full px-6 flex items-center">
          <div className="max-w-3xl text-white">
            <p className="text-xs font-black uppercase tracking-[0.4em] text-blue-300 mb-8">
              Qualität im Detail
            </p>
      ...
      <section className="py-24 md:py-32 px-6 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-lg text-slate-500 leading-relaxed font-light">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 md:gap-14 items-center">
            {partners.map((partner) => (
              <div key={partner.name} className="flex items-center justify-center">
                <img
                  src={partner.src}
                  alt={partner.name}
                  className="h-14 md:h-16 w-auto object-contain grayscale opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"
                />
              </div>
            ))}
          </div>
      ...
      <section className="py-28 md:py-36 px-6 bg-white">
        <div className="max-w-7xl mx-auto bg-slate-950 text-white px-8 md:px-16 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
